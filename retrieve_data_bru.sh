...
dataini=$2
datafinal=$3
dirwork="/home/admbackup/retrieve_data/dados${HH}"
#dirbkp="/data1/backup/backup_cosmo/metarea5/dados${HH}"
dirbkp="/storage1/backup/backup_cosmo/metarea5/dados${HH}"
...
while [ $data -le $datafinal ];do
	...
	ls -ltr cosmo_met5_${HH}_${data}024 | awk '{print $9}' | grep -v 024p > lista.raw.txt
	ls -ltr cosmo_met5_${HH}_${data}048 | awk '{print $9}' | grep -v 048p >> lista.raw.txt
...
#/home/admbackup/fontes/bin/wgrib ${grib_file} | egrep "(PMSL:|:U:|:V:)" | /home/admbackup/fontes/bin/wgrib -i -grib ${grib_file} -o raw_${new_grib}.grb:T:
	/home/admbackup/fontes/bin/wgrib ${grib_file} | egrep "(:T:kpds5=11:kpds6=105:|:PMSL:|:U:|:V:)" | /home/admbackup/fontes/bin/wgrib -i -grib ${grib_file} -o raw_${new_grib}.grb
...
#	/data1/dpns31_old/usr/local/bin/cdo cat ${new_grib}.grb cosmo_00_${data}.grb
	/usr/local/bin/cdo cat ${new_grib}.grb cosmo_${HH}_${data}.grb
	rm ${new_grib}.grb
done 

rm ${dirwork}/lista.raw.txt
rm ${dirwork}/cosmomet.${data}${HH}.tar.bz2
rm ${dirwork}/cosmo_met5_*
