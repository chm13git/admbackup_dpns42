...
if [ $# -ne 1 ];then
        ...
        echo "Exemplo: ./bkpserv.sh dpns31, dpns41, dpns35, dpns05d"
...
for diretorio in $dirbkp;do
	...
	echo 
		...
		echo ============================================================
		echo " Sincronizando os crontabs e diretorios /home do servidor dpns31"
		echo Iniciando rsync ${MAQ}... > $diretorio/newfiles_${MAQ}_${data}
		echo `date` >> $diretorio/newfiles_${MAQ}_${data}

		echo Sincronizando admcosmo@${MAQ}:/home/admcosmo >> $diretorio/newfiles_${MAQ}_${data}
		echo >> $diretorio/newfiles_${MAQ}_${data} 
               	rsync -abvzh --out-format="%t %f %'''b" --exclude-from ${direxc}'/exclude_me_'$MAQ'.txt' admcosmo@${MAQ}:/home/admcosmo $diretorio/home/  >> $diretorio/newfiles_${MAQ}_${data} 2>&1

		echo Sincronizando admcosmo@${MAQ}:/var/spool/cron/tabs/admcosmo >> $diretorio/newfiles_${MAQ}_${data}
		rsync -abvzh --out-format="%t %f %'''b" admcosmo@${MAQ}:/var/spool/cron/tabs/admcosmo $diretorio/home/admcosmo/tabs/ >> $diretorio/newfiles_${MAQ}_${data} 2>&1

		echo >> $diretorio/newfiles_${MAQ}_${data}
		echo Sincronizando operador@${MAQ}:/home/operador >> $diretorio/newfiles_${MAQ}_${data}
		echo >> $diretorio/newfiles_${MAQ}_${data}
               	rsync -abvzh --out-format="%t %f %'''b" --exclude-from ${direxc}'/exclude_me_'$MAQ'.txt' operador@${MAQ}:/home/operador $diretorio/home/ >> $diretorio/newfiles_${MAQ}_${data} 2>&1

		echo Sincronizando operador@${MAQ}:/var/spool/cron/tabs/operador >> $diretorio/newfiles_${MAQ}_${data}
		rsync -abvzh --out-format="%t %f %'''b" operador@${MAQ}:/var/spool/cron/tabs/operador $diretorio/home/operador/tabs/ >> $diretorio/newfiles_${MAQ}_${data} 2>&1

		echo >> $diretorio/newfiles_${MAQ}_${data}
		echo Sincronizando wrfoperador@${MAQ}:/home/wrfoperador >> $diretorio/newfiles_${MAQ}_${data}
		echo >> $diretorio/newfiles_${MAQ}_${data}
               	rsync -abvzh --out-format="%t %f %'''b" --exclude-from ${direxc}'/exclude_me_'$MAQ'.txt' wrfoperador@${MAQ}:/home/wrfoperador $diretorio/home/ >> $diretorio/newfiles_${MAQ}_${data} 2>&1

		echo Sincronizando wrfoperador@${MAQ}:/var/spool/cron/tabs/wrfoperador >> $diretorio/newfiles_${MAQ}_${data}
		rsync -abvzh --out-format="%t %f %'''b" wrfoperador@${MAQ}:/var/spool/cron/tabs/wrfoperador $diretorio/home/wrfoperador/tabs/ >> $diretorio/newfiles_${MAQ}_${data} 2>&1

		echo >> $diretorio/newfiles_${MAQ}_${data}
		echo Sincronizando ww3desenv@${MAQ}:/home/ww3desenv >> $diretorio/newfiles_${MAQ}_${data}
		echo >> $diretorio/newfiles_${MAQ}_${data}
               	rsync -abvzh --out-format="%t %f %'''b" --exclude-from ${direxc}'/exclude_me_'$MAQ'.txt' ww3desenv@${MAQ}:/home/ww3desenv $diretorio/home/ >> $diretorio/newfiles_${MAQ}_${data} 2>&1

		echo Sincronizando ww3desenv@${MAQ}:/var/spool/cron/tabs/ww3desenv >> $diretorio/newfiles_${MAQ}_${data}
		rsync -abvzh --out-format="%t %f %'''b" ww3desenv@${MAQ}:/var/spool/cron/tabs/ww3desenv $diretorio/home/ww3desenv/tabs/ >> $diretorio/newfiles_${MAQ}_${data} 2>&1

		echo Sincronizando operador@${MAQ}:/home/crontab_root >> $diretorio/newfiles_${MAQ}_${data}
		echo Foi utilizado o usr operador como proprietario por conveniencia. >> $diretorio/newfiles_${MAQ}_${data}
		rsync -abvzh --out-format="%t %f %'''b" operador@${MAQ}:/home/crontab_root $diretorio/home/ >> $diretorio/newfiles_${MAQ}_${data} 2>&1

		echo >> $diretorio/newfiles_${MAQ}_${data}
		echo Sincronizando gast@${MAQ}:/home/gast >> $diretorio/newfiles_${MAQ}_${data}
		echo >> $diretorio/newfiles_${MAQ}_${data}
               	rsync -abvzh --out-format="%t %f %'''b" gast@${MAQ}:/home/gast $diretorio/home/ >> $diretorio/newfiles_${MAQ}_${data} 2>&1

		#echo >> $diretorio/newfiles_${MAQ}_${data}
		#echo Sincronizando icon@${MAQ}:/home/icon >> $diretorio/newfiles_${MAQ}_${data}
		#echo >> $diretorio/newfiles_${MAQ}_${data}
               	#rsync -abvzh --out-format="%t %f %'''b" icon@${MAQ}:/home/icon $diretorio/home/ >> $diretorio/newfiles_${MAQ}_${data} 2>&1
	...
	elif [ "${MAQ}" = "dpns35" ];then


                echo ============================================================
                echo " Sincronizando o crontab e os diretorios /home/afdop e /home/operador do servidor dpns35"
                echo Iniciando rsync ${MAQ}... > $diretorio/newfiles_${MAQ}_${data}
                echo `date` >> $diretorio/newfiles_${MAQ}_${data}
