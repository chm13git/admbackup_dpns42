...
# Diretorios
D_FALT="~/scripts/dados_faltantes"
...
if [ $GRID == 'met' ]; then
	...
	DIRBKP="/data2/backup/backup_cosmo/metarea5/dados${HH}"

	#definindo o tamanho de referencia
	TAMREF=1900000

	# Definindo num dias anteriores que serao mantidos
	# 2 anos sao 24 meses ou aprox 744 dias
	nmes=24
	...
	echo "Deltando os 600 dias anteriores a primeira data do backup ($DATABKP)"
	ndiasdel=600
	...
	############## PARA COSMOANT #################
        ...
        #definindo os diretorios de busca
        DIRBKP="/data2/backup/backup_cosmo/antartica/dados${HH}"

        #definindo o tamanho de referencia
	TAMREF=495000

        # Definindo num dias anteriores que serao mantidos
        # 6 meses sao aprox 186 dias
        nmes=6
